...
class Move private constructor(private val direction: Direction, val push: Boolean) {
    ...
    fun heroTexture() = when (direction) {
        Direction.LEFT -> Textures.playerL
        Direction.RIGHT -> Textures.playerR
        Direction.UP -> Textures.playerU
        Direction.DOWN -> Textures.playerD
    }
    ...
    private fun toChar() = when (direction) {
